...
import { createContextSingleton, requireContext, getContext, setContext } from "@ycore/forge/context";
...
const authConfigContext = createContextSingleton("AuthConfigContext", null);
const authUserContext = createContextSingleton("AuthUserContext", null);
...
/**
 * @react-router/cloudflare v7.9.5
 *
