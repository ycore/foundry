...
import { AuthenticityTokenInput as AuthenticityTokenInput2, useAuthenticityToken as useAuthenticityToken2 } from "remix-utils/csrf/react";
...
function SecureForm({ children, csrf_name, errors, ...props }) {
  ...
  return !token ? /* @__PURE__ */ jsx2("div", {
    role: "alert",
...
function useSecureFetcher({ key } = {}) {
  ...
  const token = useAuthenticityToken2();
...
var SecureProvider = ({ children, token }) => {
  return /* @__PURE__ */ jsx4(AuthenticityTokenProvider, {
    token,
    children
  });
};
...
//# debugId=EB9402851EDAEACE64756E2164756E21
