...
class AuthGuard {
  ...
  constructor(options) {
    ...
    this.redirectTo = options.redirectTo || "/auth/login";
  ...
  getSessionIdFromRequest(request) {
    ...
    return cookies["__auth-session"] || null;
  }
  async isAuthenticated(context) {
    const sessionId = this.getSessionIdFromRequest(context.request);
    if (!sessionId) {
      logger.debug({
        event: "auth_guard_no_session",
        url: context.request.url
      });
      return false;
    }
    const userId = await this.sessionManager.validateSession(sessionId);
    if (!userId) {
      logger.debug({
        event: "auth_guard_invalid_session",
        sessionId,
        url: context.request.url
      });
      return false;
    ...
    logger.debug({
      event: "auth_guard_authenticated",
      userId,
      url: context.request.url
    });
    return true;
  }
  async requireAuth(context) {
  ...
  async optionalAuth(context) {
    await this.isAuthenticated(context);
  }
  async requireGuest(context) {
    const isAuth = await this.isAuthenticated(context);
    if (isAuth) {
      logger.debug({
        event: "auth_guard_already_authenticated",
...
// src/secure/components/NonceProvider.tsx
var import_react = __toESM(require_react(), 1);
var jsx_runtime = __toESM(require_jsx_runtime(), 1);
var SecureContext = import_react.createContext({});
function NonceProvider({ children, nonce }) {
  const value = {
    nonce
  };
  return /* @__PURE__ */ jsx_runtime.jsx(SecureContext.Provider, {
    value,
    children
  });
}
function useSecureContext() {
  return import_react.useContext(SecureContext);
}
function useNonce() {
  const { nonce } = useSecureContext();
  return nonce;
}
...
var RenderErrorBoundary = class extends React22.Component {
  ...
  render() {
    return this.state.error !== undefined ? /* @__PURE__ */ React22.createElement(RouteContext.Provider, { value: this.props.routeContext }, /* @__PURE__ */ React22.createElement(RouteErrorContext.Provider, {
...
function useMatches() {
  ...
  return React22.useMemo(() => matches.map((m) => convertRouteMatchToUiMatch(m, loaderData)), [matches, loaderData]);
}
...
var RSCRouterGlobalErrorBoundary = class extends import_react2.default.Component {
  ...
  render() {
    if (this.state.error) {
      return /* @__PURE__ */ import_react2.default.createElement(RSCDefaultRootErrorBoundaryImpl, {
...
function ErrorWrapper({
  ...
  return /* @__PURE__ */ import_react2.default.createElement("html", { lang: "en" }, /* @__PURE__ */ import_react2.default.createElement("head", null, /* @__PURE__ */ import_react2.default.createElement("meta", { charSet: "utf-8" }), /* @__PURE__ */ import_react2.default.createElement("meta", {
    name: "viewport",
    content: "width=device-width,initial-scale=1,viewport-fit=cover"
  }), /* @__PURE__ */ import_react2.default.createElement("title", null, title)), /* @__PURE__ */ import_react2.default.createElement("body", null, /* @__PURE__ */ import_react2.default.createElement("main", { style: { fontFamily: "system-ui, sans-serif", padding: "2rem" } }, children)));
}
function RSCDefaultRootErrorBoundaryImpl({
  ...
  console.error(error);
  let heyDeveloper = /* @__PURE__ */ import_react2.default.createElement("script", {
    dangerouslySetInnerHTML: {
      __html: `
        console.log(
  ...
  if (isRouteErrorResponse(error)) {
    return /* @__PURE__ */ import_react2.default.createElement(ErrorWrapper, {
      renderAppShell,
      title: "Unhandled Thrown Response!"
    }, /* @__PURE__ */ import_react2.default.createElement("h1", { style: { fontSize: "24px" } }, error.status, " ", error.statusText), ENABLE_DEV_WARNINGS ? heyDeveloper : null);
  }
  let errorInstance;
  ...
  return /* @__PURE__ */ import_react2.default.createElement(ErrorWrapper, { renderAppShell, title: "Application Error!" }, /* @__PURE__ */ import_react2.default.createElement("h1", { style: { fontSize: "24px" } }, "Application Error"), /* @__PURE__ */ import_react2.default.createElement("pre", {
    style: {
      padding: "2rem",
...
function AuthenticityTokenProvider({ children, token }) {
  return import_jsx_runtime.jsx(context.Provider, { value: token, children });
}
function useAuthenticityToken() {
  let token = React15.useContext(context);
  if (!token)
...
function AuthenticityTokenInput({ name = "csrf" }) {
  ...
  return import_jsx_runtime.jsx("input", { type: "hidden", value: token, name });
}

// src/secure/components/SecureForm.tsx
var jsx_runtime2 = __toESM(require_jsx_runtime(), 1);
var SecureForm = ({ children, csrf_name, ...props }) => {
  return /* @__PURE__ */ jsx_runtime2.jsxs(Form, {
    ...props,
    children: [
      /* @__PURE__ */ jsx_runtime2.jsx(AuthenticityTokenInput, {
        name: csrf_name
      }),
      children
    ]
...
// src/secure/components/SecureProvider.tsx
var jsx_runtime3 = __toESM(require_jsx_runtime(), 1);
var SecureProvider = () => {
  const { csrfToken } = useLoaderData();
  return /* @__PURE__ */ jsx_runtime3.jsx(AuthenticityTokenProvider, {
    token: csrfToken,
    children: /* @__PURE__ */ jsx_runtime3.jsx(Outlet, {})
  });
};
// src/secure/hooks/useRateLimit.ts
var import_react5 = __toESM(require_react(), 1);
function useRateLimit({ identifier, windowSeconds = 60, maxRequests = 10 }) {
  const [isLimited, setIsLimited] = import_react5.useState(false);
  const [remaining, setRemaining] = import_react5.useState(maxRequests);
  const [reset, setReset] = import_react5.useState(Date.now() + windowSeconds * 1000);
  const checkLimit = import_react5.useCallback(async () => {
    try {
  ...
  return { isLimited, remaining, reset, checkLimit };
}
  ...
  constructor() {
    ...
    this.promise = (promise, data2) => {
      ...
      const originalPromise = p.then(async (response) => {
        ...
        const isReactElementResponse = import_react6.default.isValidElement(response);
        if (isReactElementResponse) {
          ...
          const isExtendedResult = typeof promiseData === "object" && !import_react6.default.isValidElement(promiseData);
...
class RateLimiter {
  ...
  async check(identifier) {
    ...
    try {
      ...
      const errorResult = transformError(err);
      logger.error("rate_limit_error", { error: flattenErrors([errorResult]) });
      return {
        isLimited: false,
...
//# debugId=68321EBA50C2600A64756E2164756E21
