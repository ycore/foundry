...
import { createContextSingleton, requireContext, setContext } from "@ycore/forge/context";
...
const csrfContext = createContextSingleton("CSRFContext", null);
const skipCSRFValidation = createContextSingleton("SkipCSRFValidation", false);
