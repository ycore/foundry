// src/secure/csrf/server/csrf.ts
...
// src/secure/csrf/server/csrf.context.ts
import { createContext } from "react-router";
var csrfContext = createContext(null);
var skipCSRFValidation = createContext(false);
// src/secure/csrf/server/csrf.context-helper.ts
...
// src/secure/csrf/server/csrf.middleware.ts
...
// src/secure/rate-limiter/server/rate-limiter.middleware.ts
import { logger as logger2 } from "@ycore/forge/logger";
import { getClientIP, isError as isError2 } from "@ycore/forge/result";
import { data } from "react-router";

// src/secure/rate-limiter/server/rate-limiter.provider.ts
import { err as err3, isError } from "@ycore/forge/result";

// src/secure/rate-limiter/server/providers/cloudflare-rate-limiter.ts
...
// src/secure/rate-limiter/server/providers/kv-rate-limiter.ts
...
// src/secure/rate-limiter/server/route-matcher.ts
...
//# debugId=A8750E0F9A0564B164756E2164756E21
