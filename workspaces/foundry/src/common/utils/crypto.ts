...
export const random64 = (): string => {
  return jose.base64url.encode(crypto.getRandomValues(new Uint8Array(20)));
};
 ...
 */
export const base64Encode = (data: Uint8Array | string) => jose.base64url.encode(data);
...
export const base64Decode = (data: Uint8Array | string) => {
  ...
  return decoder.decode(jose.base64url.decode(data));
};
