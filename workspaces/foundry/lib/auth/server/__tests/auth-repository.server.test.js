...
describe('authRepository.findOrCreate', () => {
    beforeEach(() => {
        vi.clearAllMocks();
        resolveDatabase.mockReturnValue(mockDb);
...
describe('authRepository.findOrCreateHashed', () => {
    ...
    it('should create a new user with hashed password', async () => {
        ...
        expect(userInsertMock.values).toHaveBeenCalledWith({ email: TEST_CREDENTIALS.email });
        expect(passwordInsertMock.values).toHaveBeenCalledWith(expect.objectContaining({
...
//# sourceMappingURL=auth-repository.server.test.js.map