...
export default function Route({ loaderData }) {
    ...
    return (_jsxs(Form, { method: "POST", className: "mx-auto mt-2 flex w-1/3 flex-col gap-y-4", children: [_jsx(AuthenticityTokenInput, {}), _jsx(HoneypotInputs, {}), _jsxs(Fieldset, { children: [_jsxs(Fieldset.Field, { children: [_jsx(Fieldset.Label, { htmlFor: "email", children: "Email" }), _jsx(Input, { type: "email", name: "email", id: "email", defaultValue: authConfig?.DEV_SIGNIN.username, disabled: isSubmitting })] }), _jsxs(Fieldset.Field, { children: [_jsx(Fieldset.Label, { htmlFor: "password", children: "Password" }), _jsx(Input, { type: "password", name: "password", id: "password", defaultValue: authConfig?.DEV_SIGNIN.password, disabled: isSubmitting })] })] }), _jsxs("div", { className: "flex flex-row justify-between", children: [_jsxs(Button, { type: "submit", disabled: isSubmitting, children: [_jsx("span", { className: "pl-5", children: "Reset password" }), _jsx(Spinner, { className: isSubmitting ? 'visible' : 'invisible' })] }), _jsx(Link, { href: authConfig.routes.auth.signin, children: "Sign in" })] })] }));
}
